...
public class VideoSceneRenderer implements Renderer {
    ...
    public VideoSceneRenderer(Context context, @NotNull GvrApi api) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        api.initializeGl();
        GLUtil.checkGlError("initializeGl");
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLUtil.checkGlError("submit frame");
    }
    ...
    private void initVideoScene() {
        ...
        videoScene.setHasVideoPlaybackStarted(shouldShowVideo);
        int videoSurfaceID = BufferViewport.EXTERNAL_SURFACE_ID_NONE;
    ...
    private void drawScene(GL10 gl, Frame frame) {
        ...
        synchronized (videoPlayerLock) {
            if (videoPlayer != null) {
                videoPlayer.getPlayer().getVideoFormat();
                videoScene.updateVideoFpsFraction(
                        videoPlayer.getPlayer().getVideoDecoderCounters());
            }
        }
    ...
    private void drawSceneForEye(@NotNull GL10 gl, int eye) {
